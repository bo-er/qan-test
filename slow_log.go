...
func runClient() {
	...
	slowLogPath := flag.String("slow-log", "/opt/udb/mysql/data/mysql-slow.log", "Path to MySQL slow log file")
	logTimeStart := flag.String("logTimeStart", "2019-01-01 00:00:00", "Start fake time of query from")
	serverURL := flag.String("server-url", "127.0.0.1:9911", "ULR of QAN-API Server")
